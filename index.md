...
- [Normal union, a discriminated union, and a type predicate](mattpocockuk%20-%201592130978234900484.html)
- [Use Object.freeze to ensure your objects are readonly at the type level AND the runtime level](mattpocockuk%20-%201542079199543975937.html)
- [Inversion of control](mattpocockuk%20-%201591047557702389760.html)
- [Ultimate TypeScript Thread](mattpocockuk%20-%201509964736275927042.html)
- [TypeScript Tips Series](https://www.totaltypescript.com/tips)

### Carlos Caballero

- [Use look up tables instead of "if"](Carlillo%20-%201591148366070747347.html)

### Minko Gechev

- [Enum vs const enums](mgechev%20-%201309379618034642946.html)
- [Use labeled tuple elements to get better hints from your text editor ](mgechev%20-%201361186013029269506.html)
- [Use `as const` after literals](mgechev%20-%201462654597059817481.html)

### Cory House

- [Avoid making a property optional when the property isn’t valid in a certain case](housecor%20-%201581638360543600640.html)
- [Alias the type's name when conflicts with an existing identifier](housecor%20-%201586865516395876359.html)

### Tomek Sułkowski

- [Extract it from a component using the handy `ComponentProps`](sulco%20-%201160890708615716864.html)

### Wes Bos

- [Four ways to define an object type in TypeScript](wesbos%20-%201524040757518258176.html)
- [The difference between `any` and `unknown`](wesbos%20-%201584905090628034560.html)
- [Use TypeScript's `never` for making sure you hit every scenario](wesbos%20-%201585641232155348992.html)
- [Use TypeScript's `never` to enforce "one or the other" properties on a type](wesbos%20-%201587082842110033926.html)

### StackBlitz

- [Infers array's type as const](stackblitz%20-%201325818478675304448.html)
- [How to use extends](stackblitz%20-%201328353096179789824.html)
- [How to use readonly](stackblitz%20-%201330890655351123968.html)
...
Contributions welcome! Read the [contribution guidelines](contributing.html)
first.
